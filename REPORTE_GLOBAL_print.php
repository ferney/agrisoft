...
require_once("include/REPORTE_GLOBAL_variables.php");
...
$page_layouts["REPORTE_GLOBAL_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_GLOBAL.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_GLOBAL.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("PROPIETARIO_CEDULA_fieldheader", true);
$xt->assign("NOMBRE_fieldheader", true);
$xt->assign("VEREDA_fieldheader", true);
...
$xt->assign("LINEAS_AGRARIAS_fieldheader", true);
$xt->assign("VARIEDAD_fieldheader", true);
$xt->assign("AREA_fieldheader", true);
$xt->assign("PRODUCCION_ANUAL_fieldheader", true);
$xt->assign("A_O1_fieldheader", true);
$xt->assign("VARIEDAD_AGRICOLA_fieldheader", true);
$xt->assign("AREA1_fieldheader", true);
$xt->assign("PRODUCCION_ANUAL1_fieldheader", true);
$xt->assign("A_O2_fieldheader", true);
$xt->assign("RAZA_PECUARIO_fieldheader", true);
$xt->assign("U_A_fieldheader", true);
$xt->assign("AREA2_fieldheader", true);
$xt->assign("PRODUCCION_ANUAL2_fieldheader", true);
$xt->assign("A_O3_fieldheader", true);
$xt->assign("VARIEDAD_HORTIFRUTICOLA_fieldheader", true);
$xt->assign("AREA3_fieldheader", true);
$xt->assign("PRODUCCION_ANUAL3_fieldheader", true);
$xt->assign("A_O4_fieldheader", true);
$xt->assign("TENENCIA_LEGAL_fieldheader", true);
$xt->assign("SOPORTE_fieldheader", true);
$xt->assign("RUAT_fieldheader", true);
$xt->assign("ASOCIACION_fieldheader", true);
$xt->assign("OBSERVACIONES_fieldheader", true);
$xt->assign("A_O5_fieldheader", true);
$xt->assign("TIPO_INVERSION_fieldheader", true);
$xt->assign("NOMBRE_PROYECTO_fieldheader", true);
$xt->assign("OBSERVACIONES1_fieldheader", true);
$xt->assign("A_O6_fieldheader", true);
