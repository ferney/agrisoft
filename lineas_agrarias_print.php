...
$page_layouts["finca_masterprint"] = $layout;
...
$layout = new TLayout("masterrprint_bootstrap", "AvenueDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["REPORTE_GLOBAL_masterrprint"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["REPORTE_FINCA_masterrprint"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["REPORTE_VEREDA_masterrprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "lineas_agrarias" );
