...
require_once("include/lineas_agrarias_ESTADISTICA_variables.php");
...
$layout = new TLayout("search_bootstrap", "AvenueDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
...
$page_layouts["lineas_agrarias_ESTADISTICA_search"] = $layout;
...
$params['shortTableName'] = 'lineas_agrarias_ESTADISTICA';
