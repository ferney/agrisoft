...
class ConnectionManager
{
	...
	{
		return $this->byId( "sanjoaquinbasededatos_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "sanjoaquinbasededatos_at_localhost";
		$data["connName"] = "sanjoaquinbasededatos at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;sanjoaquinbasededatos;;1"; //currently unused
		
		$this->_connectionsIdByName["sanjoaquinbasededatos at localhost"] = "sanjoaquinbasededatos_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "sanjoaquinbasededatos";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=sanjoaquinbasededatos;OPTION=3";
		// encription set
		...
		$connectionsData["sanjoaquinbasededatos_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["agricola"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["finca"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["hortifruticola"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["inversion"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["legal"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["lineas_agrarias"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["pecuario"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["propietario"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE GLOBAL"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE FINCA"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE AGRICOLA"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE PECUARIO"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE VEREDA"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE HORTIFRUTICOLA"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE INVERSION"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE LEGAL"] = "sanjoaquinbasededatos_at_localhost";
		$connectionsIds["REPORTE LINEAS"] = "sanjoaquinbasededatos_at_localhost";
