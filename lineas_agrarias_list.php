...
$layout = new TLayout("list_bootstrap1", "AvenueDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
...
$page_layouts["lineas_agrarias_list"] = $layout;
...
$layout = new TLayout("masterreport_bootstrap", "AvenueDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["REPORTE_GLOBAL_masterreport"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["REPORTE_FINCA_masterreport"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["REPORTE_VEREDA_masterreport"] = $layout;
