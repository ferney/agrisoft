...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "agricola" ] = array( "url" => "agricola", "type" => 0 );
	$projectEntitiesReverse[ "agricola" ] = "agricola";
	$projectEntities[ "finca" ] = array( "url" => "finca", "type" => 0 );
	$projectEntitiesReverse[ "finca" ] = "finca";
	$projectEntities[ "hortifruticola" ] = array( "url" => "hortifruticola", "type" => 0 );
	$projectEntitiesReverse[ "hortifruticola" ] = "hortifruticola";
	$projectEntities[ "inversion" ] = array( "url" => "inversion", "type" => 0 );
	$projectEntitiesReverse[ "inversion" ] = "inversion";
	$projectEntities[ "legal" ] = array( "url" => "legal", "type" => 0 );
	$projectEntitiesReverse[ "legal" ] = "legal";
	$projectEntities[ "lineas_agrarias" ] = array( "url" => "lineas_agrarias", "type" => 0 );
	$projectEntitiesReverse[ "lineas_agrarias" ] = "lineas_agrarias";
	$projectEntities[ "pecuario" ] = array( "url" => "pecuario", "type" => 0 );
	$projectEntitiesReverse[ "pecuario" ] = "pecuario";
	$projectEntities[ "propietario" ] = array( "url" => "propietario", "type" => 0 );
	$projectEntitiesReverse[ "propietario" ] = "propietario";
	$projectEntities[ "REPORTE GLOBAL" ] = array( "url" => "REPORTE_GLOBAL", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_GLOBAL" ] = "REPORTE GLOBAL";
	$projectEntities[ "REPORTE FINCA" ] = array( "url" => "REPORTE_FINCA", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_FINCA" ] = "REPORTE FINCA";
	$projectEntities[ "REPORTE AGRICOLA" ] = array( "url" => "REPORTE_AGRICOLA", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_AGRICOLA" ] = "REPORTE AGRICOLA";
	$projectEntities[ "REPORTE PECUARIO" ] = array( "url" => "REPORTE_PECUARIO", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_PECUARIO" ] = "REPORTE PECUARIO";
	$projectEntities[ "REPORTE VEREDA" ] = array( "url" => "REPORTE_VEREDA", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_VEREDA" ] = "REPORTE VEREDA";
	$projectEntities[ "REPORTE HORTIFRUTICOLA" ] = array( "url" => "REPORTE_HORTIFRUTICOLA", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_HORTIFRUTICOLA" ] = "REPORTE HORTIFRUTICOLA";
	$projectEntities[ "REPORTE INVERSION" ] = array( "url" => "REPORTE_INVERSION", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_INVERSION" ] = "REPORTE INVERSION";
	$projectEntities[ "REPORTE LEGAL" ] = array( "url" => "REPORTE_LEGAL", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_LEGAL" ] = "REPORTE LEGAL";
	$projectEntities[ "REPORTE LINEAS" ] = array( "url" => "REPORTE_LINEAS", "type" => 2 );
	$projectEntitiesReverse[ "REPORTE_LINEAS" ] = "REPORTE LINEAS";
}
