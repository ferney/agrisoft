...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("agricola" == $this->chrt_array['tables'][0])
			return true;
		if("finca" == $this->chrt_array['tables'][0])
			return true;
		if("hortifruticola" == $this->chrt_array['tables'][0])
			return true;
		if("inversion" == $this->chrt_array['tables'][0])
			return true;
		if("legal" == $this->chrt_array['tables'][0])
			return true;
		if("lineas_agrarias" == $this->chrt_array['tables'][0])
			return true;
		if("pecuario" == $this->chrt_array['tables'][0])
			return true;
		if("propietario" == $this->chrt_array['tables'][0])
			return true;
		if("finca" == $this->chrt_array['tables'][0])
			return true;
		if("finca" == $this->chrt_array['tables'][0])
...
{	
	...
	{	
		if( $this->table_type == "project" && !$this->webchart ) 
		{
			...
			return $fieldName.": ". $viewValue;
		}
		
		return $this->arrDataSeries[ $seriesNumber ].": ". $value;
	}
}	
