...
require_once("include/Grafico_hortifruticola_variables.php");
...
$page_layouts["Grafico_hortifruticola_search"] = $layout;
...
$params['shortTableName'] = 'Grafico_hortifruticola';
