...
require_once("include/REPORTE_HORTIFRUTICOLA_variables.php");
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_HORTIFRUTICOLA.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_HORTIFRUTICOLA.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("AREA_OCUPADA_fieldheader", true);
