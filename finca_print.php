...
$layout = new TLayout("print_bootstrap", "AvenueDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
...
$page_layouts["finca_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["agricola_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["hortifruticola_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["inversion_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["legal_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["lineas_agrarias_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["pecuario_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_AGRICOLA_rprint"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_PECUARIO_rprint"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_HORTIFRUTICOLA_rprint"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_INVERSION_rprint"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_LEGAL_rprint"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_LINEAS_rprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "finca" );
