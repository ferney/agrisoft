...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("usuario");
}
...
class tDAL
{
	var $tblsanjoaquinbasededatos_at_localhost__agricola;
	var $tblsanjoaquinbasededatos_at_localhost__finca;
	var $tblsanjoaquinbasededatos_at_localhost__hortifruticola;
	var $tblsanjoaquinbasededatos_at_localhost__inversion;
	var $tblsanjoaquinbasededatos_at_localhost__legal;
	var $tblsanjoaquinbasededatos_at_localhost__lineas_agrarias;
	var $tblsanjoaquinbasededatos_at_localhost__pecuario;
	var $tblsanjoaquinbasededatos_at_localhost__propietario;
	var $tblsanjoaquinbasededatos_at_localhost__usuario;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "agricola", "varname" => "sanjoaquinbasededatos_at_localhost__agricola", "altvarname" => "agricola", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "finca", "varname" => "sanjoaquinbasededatos_at_localhost__finca", "altvarname" => "finca", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "hortifruticola", "varname" => "sanjoaquinbasededatos_at_localhost__hortifruticola", "altvarname" => "hortifruticola", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "inversion", "varname" => "sanjoaquinbasededatos_at_localhost__inversion", "altvarname" => "inversion", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "legal", "varname" => "sanjoaquinbasededatos_at_localhost__legal", "altvarname" => "legal", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "lineas_agrarias", "varname" => "sanjoaquinbasededatos_at_localhost__lineas_agrarias", "altvarname" => "lineas_agrarias", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "pecuario", "varname" => "sanjoaquinbasededatos_at_localhost__pecuario", "altvarname" => "pecuario", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "propietario", "varname" => "sanjoaquinbasededatos_at_localhost__propietario", "altvarname" => "propietario", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
		$this->lstTables[] = array("name" => "usuario", "varname" => "sanjoaquinbasededatos_at_localhost__usuario", "altvarname" => "usuario", "connId" => "sanjoaquinbasededatos_at_localhost", "schema" => "", "connName" => "sanjoaquinbasededatos at localhost");
	}
