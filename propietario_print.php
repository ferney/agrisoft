...
require_once("include/propietario_variables.php");
...
$page_layouts["propietario_print"] = $layout;
...
$layout->blocks["top"][] = "grid";
$page_layouts["REPORTE_VEREDA_rprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "propietario" );
