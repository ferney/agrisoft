...
$layout = new TLayout("edit_bootstrap", "AvenueDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
...
$page_layouts["lineas_agrarias_edit"] = $layout;
...
$keys["FINCA_PROPIETARIO_CEDULA"] = postvalue("editid2");
