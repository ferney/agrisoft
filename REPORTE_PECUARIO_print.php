...
require_once("include/REPORTE_PECUARIO_variables.php");
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_PECUARIO.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_PECUARIO.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("RAZA_fieldheader", true);
$xt->assign("UNIDADES_fieldheader", true);
