...
{
	$checkResult = true;
	if($mainField=="USUARIO")
		$checkResult=false;

	if($mainField=="CONTRASEÑA")
		$checkResult=false;
...
if( $strTableName == "agricola" && $mainField == "FINCA_PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
	$lookupTable = "finca";
...
if( $strTableName == "agricola" && $mainField == "NOMBRE" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"FINCA_PROPIETARIO_CEDULA", 'lookupF'=>"PROPIETARIO_CEDULA");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
	$lookupTable = "finca";
	$lookupConnection = $cman->byTable( $lookupTable );
...
if( $strTableName == "finca" && $mainField == "PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$lookupTable = "propietario";
	$lookupConnection = $cman->byTable( $lookupTable );
	if( !$lookupConnection )
	{
		$connId = $gSettings->getNotProjectLookupTableConnId( $mainField );
...
if( $strTableName == "hortifruticola" && $mainField == "FINCA_PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
...
if( $strTableName == "inversion" && $mainField == "FINCA_PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
...
if( $strTableName == "inversion" && $mainField == "NOMBRE" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
	$lookupTable = "finca";
...
if( $strTableName == "legal" && $mainField == "FINCA_PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
...
if( $strTableName == "lineas_agrarias" && $mainField == "FINCA_PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
...
if( $strTableName == "pecuario" && $mainField == "FINCA_PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "edit" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$autoCompleteFields[] = array('masterF'=>"VEREDA", 'lookupF'=>"VEREDA");
	$autoCompleteFields[] = array('masterF'=>"FINCA", 'lookupF'=>"FINCA");
...
if( $strTableName == "REPORTE GLOBAL" && $mainField == "PROPIETARIO_CEDULA" && (!$separatedSettings || $pageType == "search" ) )
{
	$autoCompleteFields[] = array('masterF'=>"NOMBRE", 'lookupF'=>"NOMBRE");
	$lookupTable = "propietario";
	$lookupConnection = $cman->byTable( $lookupTable );
