...
require_once("include/REPORTE_LEGAL_variables.php");
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_LEGAL.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=REPORTE_LEGAL.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("TENECIA_fieldheader", true);
$xt->assign("EN_PROPIEDAD_fieldheader", true);
$xt->assign("SOPORTADO_fieldheader", true);
$xt->assign("ASOCIACION_fieldheader", true);
$xt->assign("ASOCIADOS_fieldheader", true);
